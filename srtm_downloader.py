...
class SrtmDownloader:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&SRTM Downloader')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SRTM-Downloader/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'SRTM Downloader'),
            callback=self.run,
    ...
    def run(self):
        ...
        # show the dialog
        self.dlg = SrtmDownloaderDialogBase(self.iface)
        self.dlg.show()
